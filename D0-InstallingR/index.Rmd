...
### On Windows
* Click on **base**.
* Click on **Download R 3.3.2 for Windows** to download the executable file then open that file to start the installation.
...
### On Mac OS X
* Scroll down a little bit, you will see some download links designed for different version of your OS. If you have Mac OS X 10.9 (Mavericks) or higher, choose **R-3.3.2.pkg**. If your OS version is older than that, there is a link of an older version of R right below it.
